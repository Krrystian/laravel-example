...
<form class="pt-[50px] h-screen w-full flex flex-col lg:grid grid-cols-2 items-center px-16" method="POST"
    ...
    @method('PUT')
    @csrf
    <label class="col-span-2 w-full flex justify-center pb-2 pt-2" for="title">
    ...
    <!-- Left side -->
    <div class="flex flex-col items-center  h-full text-center lg:py-0 py-4">
        <div class="md:w-[500px] md:h-[500px] h-[400px] w-[300px] rounded-xl">
    ...
    <div class="h-full w-full">
        ...
        <label for="ingredients"
            ...
            <textarea id="ingredients" name="ingredients"
                class="h-[125px] rounded-xl p-2 bg-beige text-xl font-normal border-sage border-2 resize-none"
        ...
        <label for="instructions"
            ...
            <textarea id="instructions" name="instructions"
                class="h-[125px] w-full rounded-xl p-2 bg-beige text-xl font-normal border-sage border-2 resize-none"
